...
(function () {
    ...
    productaddController.$inject = ['$location', '$scope', 'sweetAlert', 'adminService'];
    function productaddController($location, $scope, sweetAlert, adminService) {
    	var ctrl = this;
        ...
        ctrl.specificationsSelect = function (id, value) {
            ...
            adminService.getSpecificationsValue (id)
	            .success(function (data) {
        ...
        ctrl.getSpecifications = function (){
        	...
        	if(ctrl.productBean.categoryId != null){
	            adminService.getSpecifications (ctrl.productBean.categoryId)
	            .success(function (data) {
        ...
        ctrl.addSpecification = function (){
            adminService.addSpecification (ctrl.specificationDto)
            .success(function (data) {
        ...
        ctrl.addSpecificationValue = function (){
            adminService.addSpecificationValue (ctrl.specificationDto1)
            .success(function (data) {
      ...
      //   };
        ...
        ctrl.uploadImage = function () {
            ...
            adminService.uploadImage (imgBean)
            .success(function (data) {
        ...
        ctrl.saveProduct = function () {
        	...
        	if(ctrl.productBean.sizeColorMaps.length > 0 && ctrl.productBean.categoryId != null && ctrl.productBean.name != null && ctrl.productBean.imgurl != null && ctrl.productBean.categoryId != null && ctrl.productBean.vendorId != null){
        		...
        		adminService.saveProduct (ctrl.productBean)
            	.success(function (data) {
